...
import { Reveal, BookingButton, LinkButton, IconMail, MarkStar } from './ui'

/** お問い合わせ：最暗の背景でサイトを締める */
export default function Contact() {
  return (
    <section id="contact" className="bg-navy-deep text-white">
      <div className="max-w-content mx-auto px-5 sm:px-8 lg:px-12
        ...
        {/* 無料相談（主導線） */}
        <Reveal className="max-w-2xl mx-auto border border-gold/35
