...
const TOPIC_KEYWORDS: Record<string, string[]> = {
  'concern-transcription': [
    '転記', '集計', '二重入力', '二度入力', '何度も入力', '毎回入力', '手入力',
    '手で入力', '手作業', '表に移', '別の表', '書き写', '写経', 'コピペ',
    'コピー&ペースト', 'コピー・ペースト', 'コピーして貼り', 'データ処理',
    'データの処理', '処理に時間', '入力に時間', '集計に時間', '集計作業',
    '転記作業', '入力作業', 'excelへ入力', 'エクセルへ入力', 'excelに入力',
    'エクセルに入力', '同じ作業を繰り返', '毎月同じ作業', '繰り返し作業',
    '同じ入力', '同じ集計',
  ],
  'concern-scattered': [
    '紙とexcel', '紙とエクセル', '紙やexcel', '紙やエクセル', 'ばらばら', 'バラバラ',
  ...
  'concern-pipeline': [
    ...
    'ステータス', '担当者', '期限管理', '案件の状況', '顧客の状況', '進捗が分からない',
    '進捗が見えない', '案件が多くて', '顧客が多くて', '誰がどこまで', '対応状況が分からない',
    '案件を把握', '顧客を把握', '一覧で見たい',
  ],
  'concern-miss': [
    '確認漏れ', '伝達漏れ', '伝え忘れ', '連絡漏れ', '報告漏れ', '申し送り', '引き継ぎ',
    'ミスが多い', '漏れがある', '誰が確認したか', '対応が完了したか', '伝わっていない',
    '共有されていない', '言った言わない', '対応漏れ', '見落とし', '見落としが多い',
    'ダブルチェックできていない',
  ],
  'concern-ai': [
    'ai', 'エーアイ', '人工知能', 'chatgpt', 'gpt', '生成ai', 'どう使えば',
    '活用方法が分から', '使い方が分から', 'ai活用', 'aiを使い', 'aiでできること',
    'ai導入', 'ai化', 'aiに興味', 'aiで何ができる',
  ],
}
